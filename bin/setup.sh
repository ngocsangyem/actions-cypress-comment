...
sed -i "s/ngocsangyem/${OWNER}/g" .github/CODEOWNERS
sed -i "s/ngocsangyem/${OWNER}/g" README.md
sed -i "s/actions-cypress-comment/${REPO}/g" README.md
sed -i "s/ngocsangyem/${OWNER}/g" .github/CONTRIBUTING.md
sed -i "s/actions-cypress-comment/${REPO}/g" .github/CONTRIBUTING.md
sed -i "s/ngocsangyem/${OWNER}/g" .github/ISSUE_TEMPLATE/bug_report.md
sed -i "s/ngocsangyem/${OWNER}/g" .github/ISSUE_TEMPLATE/feature_request.md
sed -i "s/ngocsangyem\/actions-cypress-comment/${OWNER}\/${REPO}/g" package.json
